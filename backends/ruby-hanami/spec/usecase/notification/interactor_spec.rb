...
RSpec.describe UseCase::Notification::Interactor do
  ...
  describe "#bulk_mark_read" do
    it "calls repo with all=true and returns the count" do
    ...
    it "calls store for each active staff" do
      staffs = [
        Domain::Staff::Entity.new(id: 1, name: "S1", email: "s1@example.com", provider: 1, provider_id: "p1",
          avatar: nil, role: 2, last_login_at: nil, created_at: Time.now, created_by: nil,
          updated_at: Time.now, updated_by: nil, deleted_at: nil, deleted_by: nil, version: 1),
