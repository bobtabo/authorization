...
use App\Infrastructure\Persistence\EloquentJwtIssueHistoryRepository;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(JwtIssueHistoryRepository::class, EloquentJwtIssueHistoryRepository::class);
        ...
        $this->app->singleton(JwtIssueHistoryService::class);
