...
fn api_routes() -> Router<AppState> {
    Router::new()
        ...
        .route("/clients/{identifier}/info",  get(handler::mobile_client::info))
        .route("/clients/{identifier}/start", patch(handler::mobile_client::start))
        .route("/clients/{identifier}/stop",  patch(handler::mobile_client::stop))
