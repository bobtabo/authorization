...
// The AppClientFunc type is an adapter to allow the use of ordinary
// function as AppClient mutator.
type AppClientFunc func(context.Context, *ent.AppClientMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AppClientFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AppClientMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AppClientMutation", m)
}
