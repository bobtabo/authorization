...
func (*Notification) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case notification.FieldID, notification.FieldStaffID, notification.FieldMessageType, notification.FieldCreatedBy, notification.FieldUpdatedBy, notification.FieldDeletedBy, notification.FieldVersion:
			values[i] = new(sql.NullInt64)
		case notification.FieldTitle, notification.FieldMessage, notification.FieldURL:
