...
func (_q *InvitationQuery) FirstID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *InvitationQuery) FirstIDX(ctx context.Context) uint {
...
func (_q *InvitationQuery) OnlyID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *InvitationQuery) OnlyIDX(ctx context.Context) uint {
...
func (_q *InvitationQuery) IDs(ctx context.Context) (ids []uint, err error) {
...
func (_q *InvitationQuery) IDsX(ctx context.Context) []uint {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *InvitationQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(invitation.Table, invitation.Columns, sqlgraph.NewFieldSpec(invitation.FieldID, field.TypeUint))
	_spec.From = _q.sql
